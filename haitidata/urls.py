...
urlpatterns = patterns('',
    ...
    (r'^partnerinfo/$', direct_to_template, {  'template': 'partnerinfo.html' }),
    (r'^hazardinfo/$', direct_to_template, {  'template': 'hazardinfo.html' }),
    (r'^lang\.js$', direct_to_template, { 'template': 'lang.js', 'mimetype': 'text/javascript'}),
    ...
    (r'^metadata/(?P<layer_list>.*)$', 'haitidata.core.views.metadata'),
